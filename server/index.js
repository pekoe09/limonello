...
const { beerRouter, beerTypeRouter } = require('./beer')
...
const { grapeRouter, regionRouter, wineRouter, wineTypeRouter } = require('./wine')
...
app.use('/api/beertypes', beerTypeRouter)
app.use('/api/countries', countryRouter)
app.use('/api/courses', courseRouter)
app.use('/api/cuisines', cuisineRouter)
app.use('/api/dishtypes', dishTypeRouter)
app.use('/api/foodstuffs', foodStuffRouter)
